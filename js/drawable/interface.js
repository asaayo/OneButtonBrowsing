...
/**
* TODO: break up InterfaceLine, too much overlap with drawing and interface logic
* probaly pull out draw/asthetic stuff with a superclass of 'Line'
* @constructor
*/
...
function Interface(options) {
  ...
  // how to place the value.
  // positive delay is for late 'inputs'
  // negative for those who over anticipate and give early 'inputs'
  // TODO: create training ground, a site with a few dots to practice 'aiming' the new mouse
  click_delay = options.click_delay || DEFAULT_CLICK_DELAY;

  //emitter.on('signal', acceptInput());  // TODO: generalize the input to receive an emitter
